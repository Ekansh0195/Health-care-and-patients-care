...
export default function VoiceAssistant({
  ...
  const triggerRequestPermission = async () => {
    try {
      ...
      const errMsg = "Microphone access blocked. Please grant access in your address bar.";
      setFeedbackText(errMsg);
            ...
            >
              ...
              <div className="flex items-center justify-end gap-3.5 pt-1">
                <button 
                  ...
                  className={`px-4.5 py-2.5 rounded-xl font-bold font-sans text-xs transition-colors cursor-pointer border ${
                    isDarkMode 
                ...
                <button 
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white font-bold font-sans text-xs px-5 py-2.5 rounded-xl shadow-lg shadow-blue-500/10 cursor-pointer flex items-center gap-2 transition-transform active:scale-95"
